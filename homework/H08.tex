...
即可以认为\mytextbox{服从 $\lambda=6$ 的 $\text{Poisson}$ 分布}.
...
\begin{enumerate}[(1)]
    ...
    $\sqrt{n}\geqslant \dfrac{u_{1-\alpha}+\Phi^{-1}(1-\beta(\mu))}{\mu}=\dfrac{u_{0.95}+u_{0.95}}{0.1}\approx32.898$,$n\geqslant32.898^2\approx 1082.28$, 即样本数量至少为 \mytextbox{1083} 个。
\end{enumerate}
